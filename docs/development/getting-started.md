...
See our [AI policy](/docs/development/ai-policy).

In short, you must disclose AI use, and there are limits on AI use for communication.
...
We support a modified version of Very Sleepy, a convenient little sampling profiler for Windows. See [resources](/docs/development/resources).
