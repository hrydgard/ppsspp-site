...
To get started with multiplayer in PPSSPP: [Quick-start guide](/docs/multiplayer/quickstart.md).
...
This corresponds to the physical WLAN switch on the real PSP. It's recommended to turn this off if you are not going to play multiplayer - a few games like Obscure will enable networking if this is on, which turns off save states.
...
See [How to play](/docs/multiplayer/how-to-play) for more information.
