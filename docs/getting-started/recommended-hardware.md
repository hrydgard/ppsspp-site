...
Nearly any PC made the last 15 years will have little to no issue running PPSSPP.
Do make sure to keep your graphics drivers up to date.

## macOS

Any M1 or later Mac will run it fine.
It also works on many Intel Macs but has issues on Radeon GPUs on Mac, unfortunately.

## Controllers

PPSSPP is compatible with almost any game controller.
This page lists some things that have been tested to work.
