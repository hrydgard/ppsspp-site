...
className:"meta",begin:"#",end:"$"}]})})();hljs.registerLanguage("glsl",e)})();/*! `ini` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("ini",e)})();/*! `lua` grammar compiled for Highlight.js 11.9.0 */
